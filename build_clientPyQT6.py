...
def build_executable(has_icon):
    ...
    # Системные библиотеки VC++ Redistributable и ICU не добавляются в PyQt6 сборку
    pass
...
def package_portable_zip():
    ...
    # Копирование системных DLL и opengl32sw.dll в портативный каталог отключено для PyQt6
    pass
